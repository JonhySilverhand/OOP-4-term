...
namespace Lab7
{
    public static class Command
    {
        ...
        private static RoutedUICommand _showEventsCommand;
        ...
        static Command()
        {
            ...
            _showEventsCommand = new RoutedUICommand("ShowEvents", "ShowEventsCommand", typeof(Command));
        }
        ...
        public static RoutedUICommand ShowEventsCommand
        {
            get => _showEventsCommand;
        }
